...
try:
    ...
    from playwright_weibo_publisher_web import PlaywrightWeiboPublisher
...
async def main():
    parser = argparse.ArgumentParser(description='微博全自动发布工具 (全技能整合版) - 网页版')
